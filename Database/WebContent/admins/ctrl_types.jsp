...
<body>
 ...
 %>
							...
							<td><table width="100%" border="0" cellpadding="5"
									...
									<tr>
										...
										<td bgcolor="d3eaef" height="40"><div align="center">
												<span class="STYLE10">原料序号</span>
											</div></td>
										<td bgcolor="d3eaef" height="40"><div align="center">
												<span class="STYLE10">原料名</span>
											</div></td>
										<td bgcolor="d3eaef" height="40"><div align="center">
 	...
 	if (intPage < 2)
 		...
 		out.print("<a href='ctrl_types.jsp?page=1' ><font color='#3300FF' size='2'>首页</font></a>&nbsp;");
 	...
 	if (intPage - intPageCount >= 0)
 		...
 		out.print("<a href='ctrl_types.jsp?page=" + (intPage + 1)
 				+ "'><font color='#3300FF' size='2'>下一页</font></a>&nbsp;<a href='ctrl_types.jsp?page="
