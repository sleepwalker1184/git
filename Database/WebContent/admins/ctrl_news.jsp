...
<body>
	<table width="100%" height="100%" border="0" cellspacing="0"
				...
				<table width="147" height="100%" border="0" align="center"
					...
					<tr>
						<td height="23" background="images/main_34.gif"><table
								...
								<tr>
									<td width="9%">&nbsp;</td>
									<td width="83%"><div align="center" class="STYLE5">采购记录</div></td>
									<td width="8%">&nbsp;</td>
								</tr>
							</table></td>
					</tr>
 	...
 	if (intPage < 2)
 		...
 		out.print("<a href='ctrl_news.jsp?page=1' ><font color='#3300FF' size='2'>首页</font></a>&nbsp;");
 	...
 	if (intPage - intPageCount >= 0)
 		...
 		out.print("<a href='ctrl_news.jsp?page=" + (intPage + 1)
 				+ "'><font color='#3300FF' size='2'>下一页</font></a>&nbsp;<a href='ctrl_news.jsp?page="
